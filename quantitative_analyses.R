...
# Three packages are needed: TOSTER to calculate equivalence tests, ggplot2 for
# creating the plot for Figure 2 in the manuscript, and papaja for Table 1 in 
# the manuscript. papaja was not yet on CRAN when this was written and has to 

...
# 1. set fig.height=5 in chunk options
...
The data and code necessary to reproduce all analyses reported here, as well as additional supplementary information, is available at <https://osf.io/dbhgr>. The manuscript, including the figures and statistical analyses, was created using RStudio [1.2.5019, @RStudioTeam2019] and `r my_citation`.

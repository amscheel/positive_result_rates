...
abstract: >
 ...
 \begin{tcolorbox}[colback=white,colframe=electricviolet,coltext=electricviolet,
  ...
  The present version of this manuscript has been accepted for publication at \textsl{Advances in Methods and Practices in Psychological Science}. Please cite as:
   \vspace{0.2cm}
  \begin{center}
  Scheel, A. M., Schijen, M., \& Lakens, D. (in press). An excess of positive results: Comparing the standard Psychology literature with Registered Reports. \textsl{Advances in Methods and Practices in Psychological Science}.
  \end{center}
 \end{tcolorbox}
 \vspace{0.5cm}
...
In 1959, Sterling asked: "What credence can then be given to inferences drawn from statistical tests of $H_0$ if the reader is not aware of all experimental outcomes of a kind?" 

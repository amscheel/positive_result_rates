...
The data and code necessary to reproduce all analyses reported here, as well as the [Appendix](https://osf.io/vcqya/), the [preregistration document](https://osf.io/sy927/) and additional supplementary files, are available at <https://osf.io/dbhgr>. The manuscript including figures and statistical analyses, the Appendix, and the [codebook](https://osf.io/6jrkz/) available in the supplement were created using RStudio [1.2.5019, @RStudioTeam2019] and `r my_citation`.

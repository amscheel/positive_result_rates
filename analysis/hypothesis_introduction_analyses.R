...
# Three packages are needed: stringr, reshape2, and here (to locate the data 
# file when loading it). If you want to run these analyses outside of our 
# R project, you may need to adjust the command to load the data, and you can
# do this without making use of the here package.
# Install the packages, if needed, by uncommenting the respective line(s):
